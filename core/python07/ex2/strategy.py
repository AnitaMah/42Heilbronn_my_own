...
class InvalidStrategyError(Exception):
    """Raised when ``act()`` is called on a Creature the strategy
    can't handle.
    """
...
class BattleStrategy(ABC):
    ...
    def act(self, creature: Creature) -> None:
        """Perform this strategy's actions for ``creature``, printing
        each step.
...
class AggressiveStrategy(BattleStrategy):
    """Suitable for Creatures with
    TransformCapability: transform, attack, revert.
    """
