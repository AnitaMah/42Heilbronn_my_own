...
class GameData:
    def __init__(self) -> None:
        ...
        self.actions = ["run", "eat", "sleep", "grab", "move", "climb", "swim", "use", "release"]
...
def creat_items(generator: Generator[tuple[str, str], None, None], count: int) -> list[tuple[str, str]]:
    return [next(generator) for _ in range(count)]

def get_event(event_list: list[tuple[str, str]]) -> Generator[tuple[str, str], None, None]:
